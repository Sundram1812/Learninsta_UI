...
import springbootDataAccessQuestions from "./springbootDataAccessQuestions";

function SpringbootDataAccess() {
  const { questions, title } = springbootDataAccessQuestions;
  return (
    <section>
      <motion.div
...
export default SpringbootDataAccess;

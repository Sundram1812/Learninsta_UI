...
import springbootCoreQuestions from "./springbootCoreQuestions.js"
import QuestionAnswerCard from "../../Interview/QuestionAnswerCard.jsx";

function SpringbootCore() {
  const { questions, title } = springbootCoreQuestions;
  return (
    <section>
      <motion.div

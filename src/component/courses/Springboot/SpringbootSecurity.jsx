...
import springbootSecurityQuestions from "./springbootSecurityQuestions";

function SpringbootSecurity() {
  const { questions, title } = springbootSecurityQuestions;
...
export default SpringbootSecurity;
